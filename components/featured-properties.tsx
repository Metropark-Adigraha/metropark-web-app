...
import { Building2, MapPin, Ruler, ExternalLink } from 'lucide-react';
...
const properties = [
  {
    ...
    price: "Rp 300 Jt-an",
    image:
      "https://res.cloudinary.com/dvvwmhgbq/image/upload/fl_preserve_transparency/v1736132515/IMG_8350_rvu78e_i8vbjg.jpg?_s=public-apps",
    area: "36/60 m²",
    type: "Single Family",
    slug: "type-36-60",
  },
  {
    ...
    price: "Rp 600 Jt-an",
    image:
      "https://res.cloudinary.com/dvvwmhgbq/image/upload/fl_preserve_transparency/v1736131969/sd_gjfxyt.jpg?_s=public-apps",
    area: "63/72 m²",
...
function PropertyCard({ property }: { property: Property }) {
  ...
  return (
    <motion.div
      className="group relative bg-satin-gold-900 rounded-lg overflow-hidden shadow-lg flex flex-col"
      whileHover={{ y: -8 }}
      ...
      <div className="p-6 flex-grow flex flex-col justify-between">
        <div>
          <div className="mb-4">
            ...
            <p className="text-3xl font-bold text-satin-gold-500 group-hover:text-satin-gold-600">
              {property.price}
            </p>
          </div>
        ...
        >
          <Button
            ...
            style={{ borderColor: "#C89E30", color: "#C89E30" }}
          >
            View Details
